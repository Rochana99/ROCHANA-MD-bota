...
*Note:* Most commands are owner-only`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://res.cloudinary.com/df2rnoijw/image/upload/v1752740024/bankl0exnr8remsz8t32.jpg` }, // Replace with privacy-themed image if available
                caption: privacyMenu,
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        newsletterName: "ROCHANA MD Privacy Settings",
                        serverMessageId: 143
                    }
                }
            },
